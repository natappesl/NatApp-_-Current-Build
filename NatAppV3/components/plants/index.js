    ...
    var dataProvider = app.data.defaultProvider,
        ...
        plantsModel = kendo.observable({
            ...
            itemClick: function(e) {
                var dataItem = e.dataItem || plantsModel.originalItem;

                app.mobileApp.navigate('#components/plants/details.html?uid=' + dataItem.uid);

            },
            detailsShow: function(e) {
                plantsModel.setCurrentItemByUid(e.view.params.uid);
            },
            setCurrentItemByUid: function(uid) {
                ...
                plantsModel.set('originalItem', itemModel);
                plantsModel.set('currentItem',
                    plantsModel.fixHierarchicalData(itemModel));
